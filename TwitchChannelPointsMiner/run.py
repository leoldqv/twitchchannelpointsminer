...
sys.path.append("/home/leoscoding/PointsMiner/TwitchChannelPointsMiner/")
from TwitchChannelPointsMiner import TwitchChannelPointsMiner
from logger import LoggerSettings, ColorPalette
sys.path.append("/home/leoscoding/PointsMiner/TwitchChannelPointsMiner/classes/")
from Chat import ChatPresence
from Discord import Discord
from Webhook import Webhook
from Telegram import Telegram
from Matrix import Matrix
from Pushover import Pushover
from Settings import Priority, Events, FollowersOrder
sys.path.append("/home/leoscoding/PointsMiner/TwitchChannelPointsMiner/classes/entities/")
from Bet import Strategy, BetSettings, Condition, OutcomeKeys, FilterCondition, DelayMode
from Streamer import Streamer, StreamerSettings

twitch_miner = TwitchChannelPointsMiner(
    username="theginix",
    password="QWG16maFamazing15",           # If no password will be provided, the script will ask interactively
    ...
    logger_settings=LoggerSettings(
        ...
        console_username=False,                 # Adds a username to every console olog line if True. Also adds it to Telegram, Discord, etc. Useful when you have several accounts
        ...
        telegram=Telegram(                                                          # You can omit or set to None if you don't want to receive updates on Telegram
            ...
            token="123456789:shfuihreuiheuifhiu34578347",                          # Telegram API token @BotFather
            events=[Events.STREAMER_ONLINE, Events.STREAMER_OFFLINE,
                    Events.BET_LOSE, Events.CHAT_MENTION],                          # Only these events will be sent to the chat
            disable_notification=True,                                              # Revoke the notification (sound/vibration)
        ),
        discord=Discord(
            webhook_api="https://discord.com/api/webhooks/1236441981396189294/s7FeDa8vTwmToxh5TKvS8LyEsZkg5wibbK6VlO0ufaOkTVZu7bZlvM1hMMDRNOKawLZg",  # Discord Webhook URL
            events=[Events.STREAMER_ONLINE, Events.STREAMER_OFFLINE,
                    Events.BET_LOSE, Events.CHAT_MENTION],                                  # Only these events will be sent to the chat
        ),
        webhook=Webhook(
        ...
        pushover=Pushover(
            userkey="u6jg3f6tu3z43w5b8qd57ng8gz52fp",                                             # Login to https://pushover.net/, the user token is on the main page
            token="ao9jnawmzvv57oifj84ymaqg58sdg4",                                           # Create an application on the website, and use the token shown in your application
...
twitch_miner.mine(
    [
        ...
        Streamer("", settings=StreamerSettings(make_predictions=True  , follow_raid=False ,                     watch_streak=True , bet=BetSettings(strategy=Strategy.SMART      , percentage=5 , stealth_mode=False, percentage_gap=30 , max_points=50000 , filter_condition=FilterCondition(by=OutcomeKeys.ODDS,             where=Condition.LT,  value=300 ) ) )),
